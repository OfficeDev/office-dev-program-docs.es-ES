...
## <a name="what-account-can-i-use-to-sign-up-for-the-office-365-developer-program"></a>¿Qué cuenta puedo usar para registrarme en el programa de desarrolladores de Office 365?
...
## <a name="how-can-i-get-an-office-365-developer-subscription-via-the-developer-program"></a>¿Cómo puedo obtener una suscripción para desarrolladores de Office 365 a través del Programa de Desarrolladores?  

Cuando se une al Programa de Desarrolladores de Office 365, reúnes los requisitos para obtener una suscripción gratuita para desarrolladores de Office 365. Esta es una suscripción especial diseñada para ser utilizada únicamente para el desarrollo de aplicaciones. Para obtener más información, vea [Configurar una suscripción del programa de desarrolladores de Office 365](office-365-developer-program-get-started.md).

## <a name="what-id-do-i-use-to-sign-in-to-the-developer-program-dashboard"></a>¿Qué Id. debo utilizar para iniciar sesión en el panel del programa para desarrolladores?
...
## <a name="what-id-do-i-use-to-sign-in-to-my-developer-subscription"></a>¿Qué Id. debo utilizar para iniciar sesión a mi suscripción de desarrollador?

Utilice el Id. de administrador que creó al configurar su suscripción de desarrollador. Puede encontrar su Id. de administrador en la ventana de suscripción en el [panel del programa para desarrolladores](https://developer.microsoft.com/es-ES/office/profile).
...
## <a name="how-many-user-licenses-does-the-office-365-developer-subscription-include"></a>¿Cuántas licencias de usuario incluye la suscripción para desarrolladores de Office 365?
...
## <a name="how-do-you-define-development-activity"></a>¿Cómo se define la actividad de desarrollo?
...
Para obtener más información sobre los tipos de actividades que realizamos, vea los [términos de uso de la suscripción de desarrollador de Office 365](terms-and-conditions.md). 
...
Sí, puede seguir [estas instrucciones](office-365-developer-program.md) para unirse al programa de desarrolladores de Office 365 y configurar una suscripción de desarrollador de Office 365. Pero, incluso para los proveedores, esta suscripción está diseñada para usarse _solo para el desarrollo de aplicaciones_. Si no está realizando las tareas de desarrollo válidas, no se renovará la suscripción.

## <a name="is-the-office-365-developer-program-available-in-my-language"></a>¿Está el programa de desarrolladores de Office 365 disponible en mi idioma?

Además del inglés, el programa de desarrolladores de Office 365 está disponible en los siguientes idiomas: chino (simplificado), francés, alemán, japonés, portugués (Brasil), ruso y español.

## <a name="is-the-office-365-developer-subscription-available-in-my-language"></a>¿Está la suscripción de desarrollador de Office 365 disponible en mi idioma?

La suscripción de desarrollador de Office 365 solo está disponible en inglés.
